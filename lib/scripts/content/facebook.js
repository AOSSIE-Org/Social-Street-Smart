...
function myMain(){
    ...
    for (let i=0 ;i<totalPost;i++)
    {
        ...
        let titleTime= postbox.getElementsByClassName("clearfix i_7dw-agt4b")[0].getElementsByClassName("_6a _5u5j _6b")[0];
        ...
        postcontent[i]= postbox.getElementsByClassName("_5pbx userContent _3576")[0].innerText;
        console.log(i)
